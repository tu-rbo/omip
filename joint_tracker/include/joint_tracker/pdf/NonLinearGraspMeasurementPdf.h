/*
 * NonLinearGraspMeasurementPdf.h
 *
 *      Author: roberto
 *
...
#ifndef NONLINEARGRASPMEASUREMENTPDF_H_
#define NONLINEARGRASPMEASUREMENTPDF_H_
...
namespace BFL
{
class NonLinearGraspMeasurementPdf : public AnalyticConditionalGaussianAdditiveNoise
{
public:
     ...
     * Constructor
     */
    NonLinearGraspMeasurementPdf(const Gaussian& additiveNoise);

    /**
     * Destructor
     */
    virtual ~NonLinearGraspMeasurementPdf();
...
#endif /* NONLINEARGRASPMEASUREMENTPDF_H_ */
