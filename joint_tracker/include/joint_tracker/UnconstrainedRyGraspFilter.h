...
#ifndef UnconstrainedRotationInYGraspFilter_H_
#define UnconstrainedRotationInYGraspFilter_H_
...
class UnconstrainedRyGraspFilter;
typedef boost::shared_ptr<UnconstrainedRyGraspFilter> UnconstrainedRyGraspFilterPtr;

class UnconstrainedRyGraspFilter : public JointFilter
{
public:
   ...
   * Constructor
   */
    UnconstrainedRyGraspFilter();

    /**
   * Destructor
   */
    virtual ~UnconstrainedRyGraspFilter();
   ...
   */
    UnconstrainedRyGraspFilterPtr clone() const
    {
        return (UnconstrainedRyGraspFilterPtr(doClone()));
    }

    /**
   * Copy constructor
   */
    UnconstrainedRyGraspFilter(const UnconstrainedRyGraspFilter &rev_joint);
...
protected:
   ...
   */
    ...
    virtual UnconstrainedRyGraspFilter* doClone() const
    {
        return (new UnconstrainedRyGraspFilter(*this));
    }
...
#endif /* UnconstrainedRotYGraspFilter_H_ */
